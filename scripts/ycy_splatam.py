            ...
            for iter in range(num_iters_mapping):
                ...
                with torch.no_grad():
                    ...
                    if config['mapping']['prune_gaussians']:
                        ...
                        params, variables = ycy_prune_gaussians(params, variables, optimizer, iter+1, config['mapping']['pruning_dict'], selected_keyframes, config['mapping_window_size'], keyframe_list, iter_data, time_idx)
                        if config['use_wandb']:
