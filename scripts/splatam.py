...
from ycy_utils.common_utils import save_params, save_params_ckpt, seed_everything
from ycy_utils.eval_helpers import eval, report_loss, report_progress
from ycy_utils.keyframe_selection import keyframe_selection_overlap
from ycy_utils.recon_helpers import setup_camera
from ycy_utils.slam_external import (
    build_rotation,
    calc_ssim,
    densify,
    get_visibility,
...
from ycy_utils.slam_helpers import (
    l1_loss_v1,
...
def initialize_optimizer(params, lrs_dict, tracking):
    ...
    if tracking:
        ...
        return torch.optim.Adam(param_groups, lr=0.001, eps=1e-15)  ##change lr=0.0
...
def add_new_gaussians(
    params, variables, curr_data, sil_thres, time_idx, mean_sq_dist_method
):
